...
La prochaine tâche fonctionnelle est l'implémentation bilingue du MVP conformément à DEC-0003 : interface Pulso, filtres, recherche déterministe, explications, clarifications, alternatives, erreurs, informations de confiance et d'accessibilité en français et en anglais, sans traduction automatique du contenu événementiel externe et sans fournisseur externe.
