...
const en = {
  ...
  'sidebar.myOutings': 'My outings',
  'outings.lead': 'Your tickets, and the events you said you were going to.',
  'outings.ticketsKicker': 'In your pocket',
  'outings.upcomingKicker': 'On the horizon',
  'outings.pastKicker': 'Memories',
  'outings.upcoming': 'Upcoming',
  'outings.past': 'History',
  'outings.upcomingEmpty': 'You have no upcoming event yet.',
  'outings.pastEmpty': 'No past event for now.',
  'sidebar.organizer': 'Organizer',
  'sidebar.administration': 'Administration',
  'dashboard.eventDiscussionsKicker': 'Around events',
  'dashboard.eventDiscussionsTitle': 'Recent discussions',
  'dashboard.viewEvents': 'View events',
  'sidebar.sectionExplore': 'Explore',
  ...
  'onboarding.explore': 'Explore the map',
  'onboarding.noAccount': 'No account required',
  'onboarding.welcome.title': 'Welcome to Pulso',
  'onboarding.welcome.body':
    'Discover the events and places that bring Montréal to life.',
  'onboarding.map.title': 'Explore around you',
  'onboarding.map.body':
    'Browse the map freely and see what is happening nearby.',
  'onboarding.search.title': 'Find your vibe',
  'onboarding.search.body':
    'Search for an outing or filter by date, category, price and distance.',
  'onboarding.search.optional': 'Intelligent search is always optional.',
  'onboarding.favorite.title': 'Make Pulso yours',
  'onboarding.favorite.body':
    'Save favorites without an account. Sign in only to participate, connect and sync across devices.',
  'onboarding.favorite.local': 'Favorites work without an account',
  'onboarding.favorite.account': 'Sign in only when you want more',
  ...
  // DEC-0022 §6: address disclosure on approval.
  'notif.eventAccessRequest': 'is asking for the address of',
  'notif.eventAccessApproved': 'The organizer has shared the address of',
  'notif.eventAccessDeclined': 'Your address request was declined for',
  'access.hiddenTitle': 'Address shared once approved',
  'access.hiddenBody':
    'The organizer gives the exact address once they have approved you. The pin shows the neighbourhood, not the door.',
  'access.approximate': 'Approximate location',
  'access.request': 'Ask for the address',
  'access.requesting': 'Sending…',
  'access.statusPending': 'Request sent, waiting for the organizer',
  'access.statusApproved': 'Approved — you have the exact address',
  'access.statusDeclined': 'The organizer declined this request',
  'access.messageLabel': 'A word for the organizer (optional)',
  'access.messagePlaceholder': 'Who you are, who invited you…',
  'access.send': 'Send the request',
  'access.cancel': 'Cancel',
  'access.queueTitle': 'Address requests',
  'access.queueEmpty': 'Nobody has asked yet.',
  'access.approve': 'Approve',
  'access.decline': 'Decline',
  'access.revoke': 'Revoke access',
  'access.badgePending': 'Waiting',
  ...
  'access.directoryVenueRefused':
    'The address of a venue already listed in Pulso cannot be withheld. Type the address instead of choosing an existing venue.',
  'create.venueNameOptional': 'Venue name (optional)',
  'create.preciseAddress': 'Exact address',
  'create.checkAddress': 'Check',
  'create.checking': 'Checking…',
  'create.addressNotFound':
    'Address not found. Pulso will not drop a pin at random — be more precise.',
  'create.geocoderUnavailable':
    'The check is unavailable right now. Try again.',
  'create.externalTicketingHelp':
    'An external checkout, for tickets sold elsewhere. To issue Pulso tickets instead, add a ticket type from your organizer workspace once the event is published.',
  'create.confirmPin': 'Confirm the location',
  'create.confirmPinHelp':
    'Drag the pin if the address we found is not exactly the right spot.',
  'create.pinConfirmed': 'Location confirmed',
  // DEC-0022 §2 and §3: tickets, the door, and what a scan answers.
  'tickets.mine': 'My tickets',
  'tickets.none': 'You hold no ticket yet.',
  'tickets.free': 'Free',
  'tickets.used': 'Used',
  ...
  'tickets.issued': 'Your ticket',
  'tickets.whereToFind':
    'You will find it again under My account, in the My outings tab.',
  'tickets.get': 'Get a ticket',
  'tickets.getting': 'Getting…',
  'tickets.left': '{count} left',
  'tickets.soldOut': 'Sold out',
  'tickets.salesClosed': 'Not on sale',
  'tickets.paidUnavailable': 'Paid tickets are not available yet.',
  'tickets.needApproval': 'The organizer must approve you first.',
  'tickets.limitReached': 'You already hold the maximum for this ticket.',
  'tickets.failed': 'The ticket could not be issued. Try again.',
  'tickets.types': 'Ticket types',
  'tickets.typesNone': 'No ticket type yet.',
  'tickets.addType': 'Add a ticket type',
  'tickets.typeName': 'Name',
  'tickets.typeQuantity': 'Quantity (empty = unlimited)',
  'tickets.typeMaxPerAccount': 'Maximum per account',
  'tickets.typePrice': 'Price in cents (0 = free)',
  'tickets.typePriceHelp':
    'Only free ticket types can be claimed for now: selling needs the Stripe work.',
  ...
  // DEC-0025. Rooms.
  'rooms.newGroup': 'New group',
  'rooms.groupTitle': 'Group name (optional)',
  'rooms.pick': 'Who is in it?',
  'rooms.create': 'Create',
  'rooms.creating': 'Creating…',
  'rooms.searchPlaceholder': 'Search a name or a message',
  'rooms.searchResults': 'In the messages',
  'rooms.empty': 'No conversation yet.',
  'rooms.noResult': 'Nothing found.',
  'rooms.startWriting': 'Say something',
  'rooms.you': 'You: ',
  'rooms.actions': 'Options',
  'rooms.mute': 'Mute',
  'rooms.unmute': 'Unmute',
  'rooms.pin': 'Pin',
  'rooms.unpin': 'Unpin',
  'rooms.leave': 'Leave',
  'rooms.leaveConfirm': 'Leave this conversation? The others keep it.',
  'rooms.add': 'Add someone',
  'rooms.send': 'Send',
  'rooms.attach': 'Send a photo',
  'rooms.attachFailed': 'That photo could not be sent.',
  'rooms.people': '{count} people',
  'rooms.full': 'This conversation is full.',
  'rooms.notReachable':
    'You can only add people you are already able to message.',
  ...
  'tickets.scan': 'Check',
  'tickets.scanning': 'Checking…',
  'tickets.startCamera': 'Scan with the camera',
  'tickets.stopCamera': 'Stop the camera',
  'tickets.cameraDenied':
    'Camera access was refused. Allow it, or paste the QR content below.',
  'tickets.cameraPointing': 'Point the camera at the ticket.',
  'tickets.orPaste': 'or paste the QR content',
  'tickets.scanPlaceholder': 'Ticket QR content',
  'tickets.admitted': 'Admitted',
  'tickets.alreadyUsed': 'Already used',
  'tickets.wrongEvent': 'Ticket for another event',
  'tickets.notValid': 'Ticket not valid',
  'tickets.unknownTicket': 'Unknown ticket',
  'tickets.forged': 'This QR was not issued by Pulso',
  'tickets.admissions': '{used} admitted, {valid} still to come',
  'tickets.admissionsOne': '{used} admitted, {valid} still to come',
  'tickets.cameraUnavailable':
    'This browser cannot read a QR. Paste its content instead.',
  ...
  'messages.privateBody':
    'Pick a conversation to plan, share an event and decide together.',
  'messages.writeToFriend': 'Write to a friend',
  'messages.privateConversation': 'Private conversation',
  'messages.directHint': 'A private exchange on Pulso.',
  'messages.privateChannel': 'Private',
  ...
  'messages.messageRequestsHint':
    'Read the first message, then choose whether to let the conversation into your inbox.',
  'messages.noMessageRequests': 'No message request is waiting for you.',
...
const fr = {
  ...
  'sidebar.myOutings': 'Mes sorties',
  'outings.lead':
    'Tes billets, et les événements auxquels tu as dit participer.',
  'outings.ticketsKicker': 'Dans ta poche',
  'outings.upcomingKicker': 'À l’horizon',
  'outings.pastKicker': 'Souvenirs',
  'outings.upcoming': 'À venir',
  'outings.past': 'Historique',
  'outings.upcomingEmpty': "Vous n'avez pas encore d'événement à venir.",
  'outings.pastEmpty': "Aucun événement passé pour l'instant.",
  'sidebar.organizer': 'Organisateur',
  'sidebar.administration': 'Administration',
  'dashboard.eventDiscussionsKicker': 'Autour des événements',
  'dashboard.eventDiscussionsTitle': 'Discussions récentes',
  'dashboard.viewEvents': 'Voir les événements',
  'sidebar.sectionExplore': 'Explorer',
  'sidebar.sectionMore': 'Plus',
  'onboarding.progress': "Progression de l'accueil",
  'onboarding.step': 'Étape {current} sur {total}',
  'onboarding.skip': 'Passer',
  'onboarding.back': 'Retour',
  'onboarding.next': 'Suivant',
  'onboarding.explore': 'Explorer la carte',
  'onboarding.noAccount': 'Aucun compte requis',
  'onboarding.welcome.title': 'Bienvenue sur Pulso',
  'onboarding.welcome.body':
    'Découvre les événements et les lieux qui font vibrer Montréal.',
  'onboarding.map.title': 'Explore autour de toi',
  'onboarding.map.body':
    'Parcours librement la carte et repère ce qui se passe près de toi.',
  'onboarding.search.title': 'Trouve ta vibe',
  'onboarding.search.body':
    'Recherche une sortie ou filtre par date, catégorie, prix et distance.',
  'onboarding.search.optional':
    'La recherche intelligente reste toujours facultative.',
  'onboarding.favorite.title': 'Fais de Pulso ton terrain de jeu',
  'onboarding.favorite.body':
    'Enregistre tes favoris sans compte. Connecte-toi seulement pour participer, échanger et tout synchroniser.',
  'onboarding.favorite.local': 'Favoris accessibles sans compte',
  'onboarding.favorite.account': 'Connexion seulement quand tu le souhaites',
  'profile.tabPhotos': 'Photos',
  ...
  // DEC-0022 §6 : communication de l'adresse après validation.
  'notif.eventAccessRequest': 'demande l’adresse de',
  'notif.eventAccessApproved': 'L’organisateur t’a communiqué l’adresse de',
  'notif.eventAccessDeclined': 'Ta demande d’adresse a été refusée pour',
  'access.hiddenTitle': 'Adresse communiquée après validation',
  'access.hiddenBody':
    'L’organisateur donne l’adresse exacte une fois qu’il t’a validé. Le point indique le quartier, pas la porte.',
  'access.approximate': 'Position approximative',
  'access.request': 'Demander l’adresse',
  'access.requesting': 'Envoi…',
  'access.statusPending': 'Demande envoyée, en attente de l’organisateur',
  'access.statusApproved': 'Validé — tu as l’adresse exacte',
  'access.statusDeclined': 'L’organisateur a refusé cette demande',
  'access.messageLabel': 'Un mot pour l’organisateur (facultatif)',
  'access.messagePlaceholder': 'Qui tu es, qui t’a invité…',
  'access.send': 'Envoyer la demande',
  'access.cancel': 'Annuler',
  'access.queueTitle': 'Demandes d’adresse',
  'access.queueEmpty': 'Personne n’a encore demandé.',
  'access.approve': 'Valider',
  'access.decline': 'Refuser',
  'access.revoke': 'Retirer l’accès',
  'access.badgePending': 'En attente',
  'access.badgeApproved': 'Validé',
  ...
  'access.directoryVenueRefused':
    'L’adresse d’un lieu déjà référencé dans Pulso ne peut pas être masquée. Saisis l’adresse au lieu de choisir un lieu existant.',
  'create.venueNameOptional': 'Nom du lieu (optionnel)',
  'create.preciseAddress': 'Adresse précise',
  'create.checkAddress': 'Vérifier',
  'create.checking': 'Vérification…',
  'create.addressNotFound':
    'Adresse introuvable. Pulso ne place pas un repère au hasard — précise l’adresse.',
  'create.geocoderUnavailable':
    'Vérification indisponible pour le moment. Réessaie.',
  'create.externalTicketingHelp':
    'Une billetterie externe, pour des billets vendus ailleurs. Pour émettre des billets Pulso, ajoute plutôt un type de billet depuis ton espace organisateur une fois l’événement publié.',
  'create.confirmPin': 'Confirmer l’emplacement',
  'create.confirmPinHelp':
    'Déplace le point si l’adresse trouvée n’est pas exactement au bon endroit.',
  'create.pinConfirmed': 'Emplacement confirmé',
  // DEC-0022 §2 et §3 : les billets, la porte, et ce que répond un contrôle.
  'tickets.mine': 'Mes billets',
  'tickets.none': 'Tu n’as encore aucun billet.',
  ...
  'tickets.issued': 'Ton billet',
  'tickets.whereToFind':
    'Tu le retrouveras dans Mon compte, onglet Mes sorties.',
  'tickets.get': 'Obtenir un billet',
  'tickets.getting': 'Obtention…',
  'tickets.left': 'encore {count}',
  'tickets.soldOut': 'Complet',
  'tickets.salesClosed': 'Pas en vente',
  'tickets.paidUnavailable':
    'Les billets payants ne sont pas encore disponibles.',
  'tickets.needApproval': 'L’organisateur doit d’abord te valider.',
  'tickets.limitReached': 'Tu as déjà le maximum pour ce billet.',
  'tickets.failed': 'Le billet n’a pas pu être émis. Réessaie.',
  'tickets.types': 'Types de billets',
  'tickets.typesNone': 'Aucun type de billet.',
  'tickets.addType': 'Ajouter un type de billet',
  'tickets.typeName': 'Nom',
  'tickets.typeQuantity': 'Quantité (vide = illimité)',
  'tickets.typeMaxPerAccount': 'Maximum par compte',
  'tickets.typePrice': 'Prix en centimes (0 = gratuit)',
  'tickets.typePriceHelp':
    'Seuls les billets gratuits peuvent être obtenus pour l’instant : la vente demande le travail Stripe.',
  ...
  'rooms.newGroup': 'Nouveau groupe',
  'rooms.groupTitle': 'Nom du groupe (optionnel)',
  'rooms.pick': 'Qui en fait partie ?',
  'rooms.create': 'Créer',
  'rooms.creating': 'Création…',
  'rooms.searchPlaceholder': 'Cherche un nom ou un message',
  'rooms.searchResults': 'Dans les messages',
  'rooms.empty': 'Aucune conversation pour le moment.',
  'rooms.noResult': 'Rien trouvé.',
  'rooms.startWriting': 'Écris quelque chose',
  'rooms.you': 'Toi : ',
  'rooms.actions': 'Options',
  'rooms.mute': 'Mettre en sourdine',
  'rooms.unmute': 'Réactiver',
  'rooms.pin': 'Épingler',
  'rooms.unpin': 'Désépingler',
  'rooms.leave': 'Quitter',
  'rooms.leaveConfirm': 'Quitter cette conversation ? Les autres la gardent.',
  'rooms.add': 'Ajouter quelqu’un',
  'rooms.send': 'Envoyer',
  'rooms.attach': 'Envoyer une photo',
  'rooms.attachFailed': 'Cette photo n’a pas pu être envoyée.',
  'rooms.people': '{count} personnes',
  'rooms.full': 'Cette conversation est pleine.',
  'rooms.notReachable':
    'Tu ne peux ajouter que des gens à qui tu peux déjà écrire.',
  ...
  'tickets.scan': 'Vérifier',
  'tickets.scanning': 'Vérification…',
  'tickets.startCamera': 'Scanner avec la caméra',
  'tickets.stopCamera': 'Arrêter la caméra',
  'tickets.cameraDenied':
    'Accès à la caméra refusé. Autorise-le, ou colle le contenu du QR ci-dessous.',
  'tickets.cameraPointing': 'Vise le billet avec la caméra.',
  'tickets.orPaste': 'ou colle le contenu du QR',
  'tickets.scanPlaceholder': 'Contenu du QR du billet',
  'tickets.admitted': 'Admis',
  'tickets.alreadyUsed': 'Déjà utilisé',
  'tickets.wrongEvent': 'Billet pour un autre événement',
  'tickets.notValid': 'Billet non valide',
  'tickets.unknownTicket': 'Billet inconnu',
  'tickets.forged': 'Ce QR n’a pas été émis par Pulso',
  'tickets.admissions': '{used} admis, {valid} encore attendus',
  'tickets.admissionsOne': '{used} admis, {valid} encore attendu',
  'tickets.cameraUnavailable':
    'Ce navigateur ne sait pas lire un QR. Colle plutôt son contenu.',
  ...
  'messages.tagline': 'Prépare tes prochaines sorties, simplement.',
  ...
  'messages.privateBody':
    'Choisis une conversation pour planifier, partager un événement et décider ensemble.',
  'messages.writeToFriend': 'Écrire à un ami',
  'messages.privateConversation': 'Conversation privée',
  'messages.directHint': 'Un échange privé sur Pulso.',
  'messages.privateChannel': 'Privé',
  ...
  'messages.messageRequestsHint':
    'Lis le premier message, puis choisis si cette conversation peut entrer dans ta messagerie.',
  'messages.noMessageRequests': 'Aucune demande de message ne t’attend.',
...
/**
 * DEC-0022 §1: money is integer minor units everywhere it travels, so the
 * conversion to a displayable amount happens once, here, rather than as a
 * `/ 100` scattered across whichever component happens to render a price.
 */
export function formatCadMinor(
  amountCents: number,
  locale: SupportedLocale
): string {
  return formatCad(amountCents / 100, locale);
}
